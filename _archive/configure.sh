...
echo ''
read -p "Do you want to use sergiy's dotfiles? y/n" -n 1 -r
echo    # (optional) move to a new line
if [[ $REPLY =~ ^[Yy]$ ]]
then
    echo ''
	echo "Now pulling down sergiy dotfiles..."
    ...
    if [[ $? -eq 0 ]]
    then
        echo "Successfully configured your environment with sergiy's dotfiles..."
    else
        echo "sergiy's dotfiles were not applied successfully..." >&2
fi
else 
	echo ''
    echo "You chose not to apply sergiy's dotfiles. You will need to configure your environment manually..."
	echo ''
